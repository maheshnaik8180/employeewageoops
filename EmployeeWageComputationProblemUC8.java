...
public class EmployeeWageComputationProblemUC8 {
	...
	public static void main(String[] args) {
		...
		EmployeeWageComputationProblemUC8 Store1 = new EmployeeWageComputationProblemUC8("Dmart", 10, 30, 150);
		EmployeeWageComputationProblemUC8 Store2 = new EmployeeWageComputationProblemUC8("Relaiance", 20, 28, 160);
